...
<!--[if lt IE 9]>
<script type="text/javascript" src="/style/admin/lib/html5.js"></script>
<script type="text/javascript" src="/style/admin/lib/respond.min.js"></script>
<![endif]-->
...
<!--[if IE 6]>
<script type="text/javascript" src="http:///style/admin/lib.h-ui.net/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" action="/admin/checkLogin" method="post">
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
				<div class="formControls col-xs-8">
					<input id="" name="name" type="text" placeholder="账户" class="input-text size-L" required="required">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
				<div class="formControls col-xs-8">
					<input id="" name="pass" type="password" placeholder="密码" class="input-text size-L" required="required">
				</div>
			</div>
			<div class="row cl">
